...
\begin{figure}[H]
\includegraphics[scale=0.9]{MGLMcv}
\centering
...
\begin{figure}[H]
\includegraphics[scale=0.8]{gglassocoefpath}
\centering
...
\begin{figure}[H]
\includegraphics[scale=0.9]{gglassofeatures}
\centering
...
\begin{figure}[H]
\includegraphics[scale=1]{gglassocverror}
\centering
...
\begin{figure}[H]
\includegraphics[scale=0.9]{traintestloss}
\centering
...
\begin{figure}[H]
\includegraphics[scale=0.65]{gglasso1pred}
\centering
...
\begin{figure}[H]
\includegraphics[scale=0.65]{gglasso2pred}
\centering
